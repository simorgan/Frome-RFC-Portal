            ...
            <div class="row no-gutters">
                ...
                <div class="col-md-7">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}"> <!-- this is sending to the register route and the new user will be entered into the DB-->
                            @csrf   <!-- token to keep secure -->
                            <div class="form-group">
                                <label for="name" class="sr-only">Name</label>
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Name">

                            </div>
                            @error('name') <!-- This is checking for errors -->
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong> <!-- This is the message from the error -->
                                    </span>
                            @enderror
                            <div class="form-group">
